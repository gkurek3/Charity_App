...
from charity_app.views import LandingPage, Login, AddDonation, Register, Logout, FormConfirmation, UserDetails
...
urlpatterns = [
    ...
    path('user_details/<int:id>', UserDetails.as_view(), name='user-details'),
]
